...
library(VennDiagram)    # protein set vemm
```
...
lines = c("Y1015", 
          ...
          "Y202",
          "Y102")
# broad functionality of each cell line, order to match 'lines'
...
```{r pallete}
# palette for cell lines from viridis::inferno
# order to match 'lines' and colour proximity reflects functionality proximity
# "Y1015" dark purple
# "Y101" mid purple
# "Y201" dark pink
# "Y202" orange
...
(ref:protein-venn-fig) Protein set shared by cells lines. Visualised with package **`VennDiagram`** [@VennDiagram]
